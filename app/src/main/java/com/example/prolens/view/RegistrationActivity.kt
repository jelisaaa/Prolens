    ...
    Box(
        ...
        LazyColumn(
            ...
            item {
                ...
                Text(
                    text = "Create your ProLens account",
                    fontSize = 16.sp,
                ...
                Surface(
                    ...
                    border = CardDefaults.outlinedCardBorder().copy(
                        brush = Brush.linearGradient(listOf(Color.White.copy(0.2f), Color.Transparent))
                    )
                ) {
                    Column(
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                            CustomInputField(value = firstName, onValueChange = { firstName = it }, label = "First Name", modifier = Modifier.weight(1f))
                            CustomInputField(value = lastName, onValueChange = { lastName = it }, label = "Last Name", modifier = Modifier.weight(1f))
                        }
                        ...
                        Box(
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = {},
                                readOnly = true,
                                enabled = false, // Prevents keyboard, allows click to pass to Box
                                label = { Text("Birthday", color = Color.Gray) },
                                modifier = Modifier.fillMaxWidth(),
                ...
                Row(
                    ...
                    Checkbox(
                        ...
                        colors = CheckboxDefaults.colors(uncheckedColor = Color.Gray, checkedColor = Blue)
                    )
                    Text(
                ...
                Button(
                    onClick = { /* Registration logic here */ },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(60.dp),
                    shape = RoundedCornerShape(16.dp),
...
fun CustomInputField(
    ...
    OutlinedTextField(
        ...
        leadingIcon = if (leadingIcon != null) {
            { Icon(painter = painterResource(id = leadingIcon), contentDescription = null, tint = Blue) }
        } else null,
